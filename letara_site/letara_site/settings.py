"""
Django settings for letara_site project.
...
SECRET_KEY = "django-insecure-(uz&f*(ns2quch-fm=p^5mx1sbe$5t2g-3&%a%@5&bk3+_(du7"
...
WSGI_APPLICATION = "letara_site.wsgi.application"
